...
const Portfolio21440Page: React.FC = () => {
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-epilogue items-center justify-end mx-auto w-full">
        ...
        <div className="bg-red-50 flex flex-col items-center justify-start p-[68px] md:px-10 sm:px-5 w-full">
          <div className="flex flex-col md:gap-10 gap-[68px] items-center justify-start max-w-[1170px] mb-[16935px] mx-auto w-full">
            ...
            <div className="flex flex-col items-start justify-start w-full">
              <div className="md:gap-5 gap-[30px] grid sm:grid-cols-1 md:grid-cols-2 grid-cols-3 justify-center min-h-[auto] w-full">
                <div className="h-[416px] relative w-full">
                  <Img
                    ...
                    src="images/img_bitmap_416x370.png"
                    alt="bitmap"
                  />
                ...
                <div className="md:h-[415px] h-[416px] relative w-full">
                  <Img
                    className="h-[415px] m-auto object-cover rounded-md w-full"
                    src="images/img_bitmap_415x370.png"
                    alt="bitmap"
                  />
                  <div className="absolute bg-gray-900_77 flex flex-col gap-[26px] h-full inset-[0] items-start justify-center m-auto p-12 md:px-10 sm:px-5 rounded-md w-full">
                    <Button
              ...
              <Button
                className="cursor-pointer font-black leading-[normal] min-w-[170px] md:ml-[0] ml-[500px] mt-20 text-center text-sm uppercase"
                shape="round"
                color="white_A700"
              >
                Load More
...
export default Portfolio21440Page;
